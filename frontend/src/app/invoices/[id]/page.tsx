...
import { fetchInvoice, deleteInvoice, updateInvoice, updateInvoiceStatus, fetchDuplicates, reExtractInvoice, fetchAuditLog, DuplicateGroup, AuditEntry } from "@/lib/api";
        ...
        <div className="w-1/2 overflow-y-auto space-y-4">
          ...
          {activeTab === "details" && (
            <>
              {/* Job / Cost Coding */}
              <div className="rounded-xl p-5" style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }}>
                <h3 className="text-sm font-medium mb-4" style={{ color: "var(--text-muted)" }}>JOB COST CODING</h3>
                {editing ? (
